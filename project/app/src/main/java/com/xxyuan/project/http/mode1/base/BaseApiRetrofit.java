package com.xxyuan.project.http.mode1.base;

import com.blankj.utilcode.util.LogUtils;
import com.blankj.utilcode.util.NetworkUtils;
import com.xxyuan.project.app.XxyuanApplication;
import com.xxyuan.project.http.mode1.base.persistentcookiejar.ClearableCookieJar;
import com.xxyuan.project.http.mode1.base.persistentcookiejar.PersistentCookieJar;
import com.xxyuan.project.http.mode1.base.persistentcookiejar.cache.SetCookieCache;
import com.xxyuan.project.http.mode1.base.persistentcookiejar.persistence.SharedPrefsCookiePersistor;
...
//        loggingInterceptor.setLevel(HttpLoggingInterceptor.Level.NONE);//这里可以选择拦截级别
        ...
        //cache
        File httpCacheDir = new File(XxyuanApplication.getContext().getCacheDir(), "response");
        int cacheSize = 10 * 1024 * 1024;// 10 MiB
        Cache cache = new Cache(httpCacheDir, cacheSize);

        //cookie
        ClearableCookieJar cookieJar =
                new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(XxyuanApplication.getContext()));
...
//                .addHeader("Cookie", "add cookies here")
    ...
    class LoggingInterceptor implements Interceptor {
        ...
        public Response intercept(Interceptor.Chain chain) throws IOException {
            ...
            LogUtils.d(String.format("发送请求 %s on %s%n%s",
