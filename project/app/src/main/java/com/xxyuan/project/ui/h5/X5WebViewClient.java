...
public class X5WebViewClient extends WebViewClient {
    ...
    public void onReceivedError(WebView view, int errorCode, String description, String
        ...
        LogUtils.i("-------onReceivedError-------"+failingUrl);
        if (errorCode == 404) {
    ...
    public void onScaleChanged(WebView view, float oldScale, float newScale) {
        ...
        LogUtils.i("-------onScaleChanged-------"+newScale);
        //视频全屏播放按返回页面被放大的问题
    ...
    public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
        ...
        LogUtils.i("-------onReceivedError-------"+error.getDescription().toString());
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            LogUtils.d("服务器异常"+error.getDescription().toString());
        }
    ...
    public void onReceivedHttpError(WebView view, WebResourceRequest request,
        ...
        LogUtils.i("-------onReceivedError-------"+ statusCode + "-------"+reasonPhrase);
        if (webListener!=null){
            webListener.showErrorView(X5WebUtils.ErrorMode.RECEIVED_ERROR);
        }
    }
    ...
    public void onReceivedLoginRequest(WebView view, String realm, String account, String args) {
        ...
        LogUtils.i("-------onReceivedLoginRequest-------"+ args);
    }
    ...
    public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
        ...
        LogUtils.i("-------onReceivedSslError-------"+ error.getUrl());
        if (error!=null){
            String url = error.getUrl();
            if (webListener!=null){
                webListener.showErrorView(X5WebUtils.ErrorMode.SSL_ERROR);
            }
            LogUtils.i("onReceivedSslError----异常url----"+url);
        }
        //https忽略证书问题
        if (handler!=null){
            //表示等待证书响应
